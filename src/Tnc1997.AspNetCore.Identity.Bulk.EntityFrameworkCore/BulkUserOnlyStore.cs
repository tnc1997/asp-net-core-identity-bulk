...
namespace Tnc1997.AspNetCore.Identity.Bulk.EntityFrameworkCore
{
        ...
        where TUserToken : IdentityUserToken<TKey>, new()
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            ThrowIfDisposed();
            if (normalizedEmails is null) throw new ArgumentNullException(nameof(normalizedEmails));
            ...
            CancellationToken cancellationToken)
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            if (normalizedUserNames is null) throw new ArgumentNullException(nameof(normalizedUserNames));
