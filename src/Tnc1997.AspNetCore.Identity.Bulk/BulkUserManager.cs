    ...
    where TUser : class
{
    ...
    /// </summary>
    public virtual IdentityErrorDescriber ErrorDescriber { get; } = errors ?? new IdentityErrorDescriber();

    /// <summary>
    /// The <see cref="IBulkLookupNormalizer"/> used to normalize things like user and role names.
    /// </summary>
    public virtual IBulkLookupNormalizer? KeyNormalizer { get; } = keyNormalizer;
    ...
    /// </summary>
    public virtual IdentityOptions Options { get; } = optionsAccessor.Value;

    /// <summary>
    /// The <see cref="IBulkPasswordHasher{TUser}"/> used to hash passwords.
    /// </summary>
    public virtual IBulkPasswordHasher<TUser> PasswordHasher { get; } = passwordHasher;

    /// <summary>
    /// The <see cref="IBulkPasswordValidator{TUser}"/>s used to validate passwords.
    /// </summary>
    public virtual IEnumerable<IBulkPasswordValidator<TUser>> PasswordValidators { get; } = passwordValidators ?? [];
    
    /// <summary>
    /// Gets a flag indicating whether the backing user store supports user emails.
    /// </summary>
    public virtual bool SupportsUserEmail { get; } = store is IBulkUserEmailStore<TUser>;
    
    /// <summary>
    /// Gets a flag indicating whether the backing user store supports user lock-outs.
    /// </summary>
    public virtual bool SupportsUserLockout { get; } = store is IBulkUserLockoutStore<TUser>;

    /// <summary>
    /// Gets a flag indicating whether the backing user store supports security stamps.
    /// </summary>
    public virtual bool SupportsUserSecurityStamp { get; } = store is IBulkUserSecurityStampStore<TUser>;

    /// <summary>
    /// The <see cref="IBulkUserValidator{TUser}"/>s used to validate users.
    /// </summary>
    public virtual IEnumerable<IBulkUserValidator<TUser>> UserValidators { get; } = userValidators ?? [];
    ...
    /// </summary>
    protected IBulkUserStore<TUser> Store { get; } = store;
    ...
    /// of the operation.
    /// </returns>
    public virtual async Task<IEnumerable<IdentityResult>> AddLoginsAsync(IEnumerable<(TUser, UserLoginInfo)> tuples)
    {
    ...
    public virtual async Task<IEnumerable<IdentityResult>> AddPasswordsAsync(IEnumerable<(TUser, string)> tuples)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(tuples);
    ...
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="IdentityResult"/>s of the operation.</returns>
    public virtual async Task<IEnumerable<IdentityResult>> AddToRolesAsync(IEnumerable<(TUser, string)> tuples)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(tuples);
    ...
    public virtual async Task<IEnumerable<bool>> AreEmailsConfirmedAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
    ...
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="IdentityResult"/>s of the operation.</returns>
    public virtual async Task<IEnumerable<IdentityResult>> CreateAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="IdentityResult"/>s of the operation.</returns>
    public virtual async Task<IEnumerable<IdentityResult>> DeleteAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    public virtual async Task<IEnumerable<TUser?>> FindByEmailsAsync(IEnumerable<string> emails)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ...
        {
            var keyRing = services!.GetRequiredService<ILookupProtectorKeyRing>();
            var protector = services!.GetRequiredService<ILookupProtector>();
    ...
    public virtual Task<IEnumerable<TUser?>> FindByIdsAsync(IEnumerable<string> userIds)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
    ...
    public virtual async Task<IEnumerable<TUser?>> FindByLoginsAsync(IEnumerable<(string, string)> tuples)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(tuples);
    ...
    public virtual async Task<IEnumerable<TUser?>> FindByNamesAsync(IEnumerable<string> userNames)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
    ...
    public virtual async Task<IEnumerable<string?>> GetEmailsAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    public virtual async Task<IEnumerable<bool>> GetLockoutEnabledAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    public virtual async Task<IEnumerable<DateTimeOffset?>> GetLockoutEndDatesAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    public virtual async Task<IEnumerable<IEnumerable<UserLoginInfo>>> GetLoginsAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    public virtual async Task<IEnumerable<IEnumerable<string>>> GetRolesAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    public virtual async Task<IEnumerable<string>> GetUserIdsAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    public virtual async Task<IEnumerable<string?>> GetUserNamesAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    public virtual Task<IEnumerable<IEnumerable<TUser>>> GetUsersInRolesAsync(IEnumerable<string> roleNames)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
    ...
    public virtual IEnumerable<string?> NormalizeEmails(IEnumerable<string?> emails)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(emails);
    ...
    public virtual IEnumerable<string?> NormalizeNames(IEnumerable<string?> names)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
    ...
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="IdentityResult"/>s of the operation.</returns>
    public virtual async Task<IEnumerable<IdentityResult>> RemoveFromRoleAsync(IEnumerable<(TUser, string)> tuples)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(tuples);
    ...
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="IdentityResult"/>s of the operation.</returns>
    public virtual async Task<IEnumerable<IdentityResult>> RemoveLoginsAsync(IEnumerable<(TUser, string, string)> tuples)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(tuples);
    ...
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="IdentityResult"/>s of the operation.</returns>
    public virtual async Task<IEnumerable<IdentityResult>> SetEmailsAsync(IEnumerable<(TUser, string?)> tuples)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(tuples);
    ...
    public virtual async Task<IEnumerable<IdentityResult>> SetLockoutEnabledAsync(IEnumerable<(TUser, bool)> tuples)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(tuples);
    ...
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="IdentityResult"/>s of the operation.</returns>
    public virtual async Task<IEnumerable<IdentityResult>> SetLockoutEndDatesAsync(IEnumerable<(TUser, DateTimeOffset?)> tuples)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(tuples);
    ...
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="IdentityResult"/>s of the operation.</returns>
    public virtual async Task<IEnumerable<IdentityResult>> SetUserNamesAsync(IEnumerable<(TUser, string?)> tuples)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(tuples);
    ...
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="IdentityResult"/>s of the operation.</returns>
    public virtual async Task<IEnumerable<IdentityResult>> UpdateAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    public virtual async Task UpdateNormalizedEmailsAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    public virtual async Task UpdateNormalizedUserNamesAsync(IEnumerable<TUser> users)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        ArgumentNullException.ThrowIfNull(users);
    ...
    protected async Task<IEnumerable<IdentityResult>> ValidateUsersAsync(IEnumerable<TUser> users)
    {
    ...
    protected virtual async Task<IEnumerable<IdentityResult>> UpdatePasswordHashes(IEnumerable<(TUser, string?, bool)> tuples)
    {
        var results = new List<IdentityResult>();
    ...
    /// <returns>The <see cref="IdentityResult"/>s representing whether the updates were successful.</returns>
    protected async Task<IEnumerable<IdentityResult>> ValidatePasswordsAsync(IEnumerable<(TUser, string?)> tuples)
    {
    ...
    private IEnumerable<string?> ProtectPersonalData(IEnumerable<string?> data)
    {
        if (Options.Stores.ProtectPersonalData)
        {
            var keyRing = services!.GetRequiredService<ILookupProtectorKeyRing>();
    ...
    private async Task UpdateSecurityStampsInternal(IEnumerable<TUser> users)
    {
        if (SupportsUserSecurityStamp)
        {
